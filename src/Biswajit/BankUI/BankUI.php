...
use Biswajit\BankUI\libs\jojoe77777\FormAPI\SimpleForm;
use Biswajit\BankUI\libs\jojoe77777\FormAPI\CustomForm;
...
class BankUI extends PluginBase implements Listener{
    ...
    {
		$this->getLogger()->info("§aPlugin Aktif!! §eMade By Ayush");
...
//        $form = $api->createSimpleForm(function (Player $player, int $data = null) {
        ...
        $form->setTitle("§Money withdrawal");
        $form->setContent("Money in the bank: Rp" . $playerBankMoney->get("Money"));
        $form->addButton("§lPull all\n§r§dClick to use...",0,"textures/ui/icon_book_writable");
        $form->addButton("§lPull in half\n§r§dClick to use...",0,"textures/ui/icon_book_writable");
        $form->addButton("§lCustom withdrawals\n§r§dClick to use...",0,"textures/ui/icon_book_writable");
...
//        $form = $api->createCustomForm(function (Player $player, array $data = null) {
        $form = new CustomForm(function (Player $player, $data) {
            ...
            $player->sendMessage("§aSuccessfully withdraw" . $data[1] . " dari Bank");
            if ($playerBankMoney->get('Transactions') === 0){
...
//        $form = $api->createSimpleForm(function (Player $player, int $data = null) {
        $form = new SimpleForm(function (Player $player, int $data = null){
            ...
            switch ($result) {
                case 1;
                    ...
                    $player->sendMessage("§aSuccessfully saved Rp" . $playerMoney / 2 . " ke Bank");
        ...
        $form->setContent("Money in the bank: Rp" . $playerBankMoney->get("Money"));
        $form->addButton("§lSave all\n§r§dClick to use...",0,"textures/items/map_filled");
        $form->addButton("§lSave half\n§r§dClick to use...",0,"textures/items/map_filled");
        $form->addButton("§lSave Custom\n§r§dClick to use...",0,"textures/items/map_filled");
        $form->addButton("§l§cEXIT\n§r§dClick to close...",0,"textures/ui/cancel");
        $form->sendtoPlayer($player);
        return $form;
    }
...
//        $form = $api->createCustomForm(function (Player $player, array $data = null) {
        ...
        $form->addLabel("Money in bank: Rp" . $playerBankMoney->get("Money"));
